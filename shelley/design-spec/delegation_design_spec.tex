...
\item
  ...
  \(vks_{\text{hot}'}\).
\item
  The epoch number starting from which this certificate will be valid. The
  certificate will be considered valid for 90 days, from the beginning of that
  epoch.
\end{itemize}
...
ada by \({1.0021}^{73}-1\approx 0.16=16\%\) per year (which sounds
pretty high\ldots).
